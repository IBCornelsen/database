...
ALTER TABLE
	energieausweise
ADD
	CONSTRAINT energieausweise_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);

ALTER TABLE
	gebaeude_plaene
ADD
	CONSTRAINT gebaeude_plaene_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);

ALTER TABLE
	angebote
ADD
	CONSTRAINT angebote_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);

ALTER TABLE
	gebaeude_geometrie
ADD
	CONSTRAINT gebaeude_geometrie_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);

ALTER TABLE
	energiekennwerte
ADD
	CONSTRAINT energiekennwerte_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);

ALTER TABLE
	energieausweise
ADD
	CONSTRAINT energieausweise_gebaeude_geometrie_id_fkey FOREIGN KEY (gebaeude_geometrie_id) REFERENCES gebaeude_geometrie (id);

ALTER TABLE
	energieausweise
ADD
	CONSTRAINT energieausweise_energiekennwerte_id_fkey FOREIGN KEY (energiekennwerte_id) REFERENCES energiekennwerte (id);

ALTER TABLE
	gebaeude_bilder
ADD
	CONSTRAINT gebaeude_bilder_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);

ALTER TABLE
	gebaeude
ADD
	CONSTRAINT gebaeude_benutzer_id_fkey FOREIGN KEY (benutzer_id) REFERENCES benutzer (id);

ALTER TABLE
	rechnungen
ADD
	CONSTRAINT rechnungen_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);
...
ALTER TABLE
	gebaeude
ADD
	CONSTRAINT gebaeude_versand_adressen_id_fkey FOREIGN KEY (versand_adressen_id) REFERENCES adressen (id);
...
ALTER TABLE
	anteilshaber
ADD
	CONSTRAINT anteilshaber_gebaeude_id_fkey FOREIGN KEY (gebaeude_id) REFERENCES gebaeude (id);
