...
-- AlterTable
ALTER TABLE "BedarfsausweisWohnen" ADD COLUMN     "beschreibung" TEXT,
...
-- AlterTable
ALTER TABLE "VerbrauchsausweisGewerbe" ADD COLUMN     "beschreibung" TEXT,
ALTER COLUMN "uid" SET DEFAULT 'vag-' || gen_random_uuid();

-- AlterTable
ALTER TABLE "VerbrauchsausweisWohnen" ADD COLUMN     "beschreibung" TEXT,
