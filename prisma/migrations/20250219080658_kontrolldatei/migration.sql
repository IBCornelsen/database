...
-- AlterTable
ALTER TABLE "BedarfsausweisWohnen" ADD COLUMN     "kontrolldatei_angefragt" BOOLEAN DEFAULT false,
...
-- AlterTable
ALTER TABLE "VerbrauchsausweisGewerbe" ADD COLUMN     "kontrolldatei_angefragt" BOOLEAN DEFAULT false,
ALTER COLUMN "uid" SET DEFAULT 'vag-' || gen_random_uuid();

-- AlterTable
ALTER TABLE "VerbrauchsausweisWohnen" ADD COLUMN     "kontrolldatei_angefragt" BOOLEAN DEFAULT false,
