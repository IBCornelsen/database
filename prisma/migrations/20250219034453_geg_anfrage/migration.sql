...
-- AlterTable
ALTER TABLE "BedarfsausweisWohnen" ADD COLUMN     "geg_anfrage" BOOLEAN DEFAULT false,
...
-- AlterTable
ALTER TABLE "VerbrauchsausweisGewerbe" ADD COLUMN     "geg_anfrage" BOOLEAN DEFAULT false,
ALTER COLUMN "uid" SET DEFAULT 'vag-' || gen_random_uuid();

-- AlterTable
ALTER TABLE "VerbrauchsausweisWohnen" ADD COLUMN     "geg_anfrage" BOOLEAN DEFAULT false,
