/*
  ...
  - You are about to drop the column `bezahlmethode` on the `GEGEinpreisung` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "GEGEinpreisung" DROP COLUMN "bezahlmethode",
